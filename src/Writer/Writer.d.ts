...
declare function Writer<T=any, M=any>(monoid: Monoid<M>): <TYPE = T>(entry: M, value: TYPE) => Writer<TYPE, M>;

declare class Writer<T=any, M=any> implements Functor<T>, Monad<T>, Applicative<T> {
