import { Applicative, Functor, Monad, UnaryFunction } from '../interfaces/index';
import Pair from '../Pair';

declare function State<VALUE=any, STATE=any>(val: (state: VALUE) => Pair<VALUE,STATE>): State<STATE, VALUE>;

declare class State<STATE=any, VALUE=any> implements Functor<VALUE>, Monad<VALUE>, Applicative<VALUE> {
