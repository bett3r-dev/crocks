...
declare function Either<Left= any, Right= any>(val: Right): Either<Left,Right>;

declare class Either<Left=any, Right=any> implements Functor<Right>, Monad<Right>, Applicative<Right>  {
